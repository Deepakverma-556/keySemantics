        ...
        <div className='bg-hero bg-cover bg-no-repeat bg-center pt-[49px] pb-[287px] max-lg:pb-20 max-md:pb-16 max-sm:pb-12 max-lg:pt-8 max-md:pt-4 relative bg-lightGray'>
            ...
            <div className='max-w-[1232px] mx-auto px-4 relative z-10'>
                <div className='flex items-center justify-between'>
                    ...
                    <CustomButton text='Request a demo' myClass='text-sm py-[11.34px] px-[14.53px] border border-blue text-blue hover:text-white after:bg-blue ' />
                </div>
                ...
                <CustomButton text='Get started' myClass='font-medium text-base py-[18px] px-[31.61px] bg-blue text-white after:bg-sky mx-auto' />
            </div>
        </div>
    )
}
